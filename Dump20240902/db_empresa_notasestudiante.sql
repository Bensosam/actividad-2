...
--
-- Table structure for table `notasestudiante`
--

DROP TABLE IF EXISTS `notasestudiante`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `notasestudiante` (
...
--
-- Dumping data for table `notasestudiante`
--

LOCK TABLES `notasestudiante` WRITE;
/*!40000 ALTER TABLE `notasestudiante` DISABLE KEYS */;
/*!40000 ALTER TABLE `notasestudiante` ENABLE KEYS */;
UNLOCK TABLES;
